            ...
            <div>
              ...
              <div className="mt-2 space-y-2">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="role-eleve" className="ml-3 block text-sm font-medium text-gray-700">
                    Élève
                  </label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
                  />
                  <label htmlFor="role-formateur" className="ml-3 block text-sm font-medium text-gray-700">
                    Formateur
                  </label>
                </div>
              </div>
              {errors.role && (
                <p className="mt-1 text-sm text-red-600">Veuillez sélectionner un type de compte</p>
              )}
            </div>
