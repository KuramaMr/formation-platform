...
export default function SignIn() {
  ...
  const showResetPasswordForm = () => {
    setFormAnimation('form-exit');
    setTimeout(() => {
      setShowResetForm(true);
      setResetEmail(emailValue || '');
      setResetSent(false);
      setFormAnimation('form-enter');
    }, 400);
  };
  
  const returnToLoginForm = () => {
    setFormAnimation('form-leave');
    setTimeout(() => {
      setShowResetForm(false);
      setFormAnimation('form-return');
    }, 400);
  };
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-6 py-16 relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl relative z-10 px-6 py-8">
        <AuthTransition currentPage="signin">
          <div className="relative backdrop-blur-lg bg-white/30 border border-white/50 rounded-3xl shadow-2xl overflow-hidden animate-glass-shimmer depth-shadow-card">
            ...
            <div className="relative p-10 md:p-12">
              ...
              {showResetForm ? (
                <form className={`space-y-8 ${formAnimation}`} onSubmit={handleResetPassword}>
                  <div>
                ...
                <form className={`space-y-8 ${formAnimation}`} onSubmit={handleSubmit(onSubmit)}>
                  <div>
