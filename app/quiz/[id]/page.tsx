        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="mt-5">
                <Link href="/formations" className="inline-flex items-center px-4 py-2 border border-indigo-700 text-sm font-medium rounded-md shadow-[0_3px_0_0_#4338ca,0_3px_6px_rgba(0,0,0,0.1)] hover:shadow-[0_2px_0_0_#4338ca,0_2px_3px_rgba(0,0,0,0.1)] hover:translate-y-[1px] active:shadow-none active:translate-y-[3px] active:bg-indigo-700 text-white bg-indigo-600 transition-all duration-75">
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="mt-6 flex space-x-3">
                <Link href={`/cours/${cours.id}`} className="inline-flex items-center px-4 py-2 border border-indigo-700 text-sm font-medium rounded-md shadow-[0_3px_0_0_#4338ca,0_3px_6px_rgba(0,0,0,0.1)] hover:shadow-[0_2px_0_0_#4338ca,0_2px_3px_rgba(0,0,0,0.1)] hover:translate-y-[1px] active:shadow-none active:translate-y-[3px] active:bg-indigo-700 text-white bg-indigo-600 transition-all duration-75">
                  Retour au cours
                </Link>
                <Link href="/resultats/eleve" className="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-[0_3px_0_0_#cbd5e1,0_3px_6px_rgba(0,0,0,0.1)] hover:shadow-[0_2px_0_0_#cbd5e1,0_2px_3px_rgba(0,0,0,0.1)] hover:translate-y-[1px] active:shadow-none active:translate-y-[3px] active:bg-gray-50 text-gray-700 bg-white transition-all duration-75">
            ...
            {userData?.role === 'formateur' && (
              <div className="flex space-x-2">
                ...
                <button 
                  ...
                  className="inline-flex items-center px-4 py-2 rounded-md border border-red-700 bg-red-600 text-white shadow-[0.25rem_0.25rem_0px_0px_rgba(0,0,0,0.1)] transition-all hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0.25rem_0.5rem_0px_0px_rgba(0,0,0,0.1)] active:translate-y-0 active:shadow-[0.25rem_0.25rem_0px_0px_rgba(0,0,0,0.1)]"
                >
                  Supprimer
                </button>
                <button 
                  onClick={handleDeleteResults}
                  className="inline-flex items-center px-4 py-2 rounded-md border border-yellow-700 bg-yellow-600 text-white shadow-[0.25rem_0.25rem_0px_0px_rgba(0,0,0,0.1)] transition-all hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0.25rem_0.5rem_0px_0px_rgba(0,0,0,0.1)] active:translate-y-0 active:shadow-[0.25rem_0.25rem_0px_0px_rgba(0,0,0,0.1)]"
                >
                  Supprimer résultats
                </button>
              </div>
            ...
            {submitted ? (
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="mt-6 flex justify-between">
                  <Link 
                    href={`/cours/${cours?.id}`}
                    className="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-[0_3px_0_0_#cbd5e1,0_3px_6px_rgba(0,0,0,0.1)] hover:shadow-[0_2px_0_0_#cbd5e1,0_2px_3px_rgba(0,0,0,0.1)] hover:translate-y-[1px] active:shadow-none active:translate-y-[3px] active:bg-gray-50 text-gray-700 bg-white transition-all duration-75"
                  >
                    Retour au cours
                  </Link>
              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="mt-6">
                  <button
                    ...
                    className="w-full flex justify-center py-2 px-4 rounded-md border border-indigo-700 bg-indigo-600 text-white shadow-[0.25rem_0.25rem_0px_0px_rgba(0,0,0,0.1)] transition-all hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0.25rem_0.5rem_0px_0px_rgba(0,0,0,0.1)] active:translate-y-0 active:shadow-[0.25rem_0.25rem_0px_0px_rgba(0,0,0,0.1)]"
                  >
